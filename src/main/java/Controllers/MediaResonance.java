...
import Requests.ShowMediaResonance;
import Start.Main;
...
public class MediaResonance implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        ShowMediaResonance.showInfo(searchButton, channelIdField, tableView, nameColumn, dateColumn, subsColumn,
