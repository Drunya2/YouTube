...
import Requests.SortMediaResonance;
import Start.Main;
...
public class SortByMediaResonance implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        SortMediaResonance.showSort(searchButton, channelIdField, tableView, nameColumn, dateColumn, subsColumn,
